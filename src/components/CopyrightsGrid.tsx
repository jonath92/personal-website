...
const ImageDiv = styled.div`
    ...
    background-size: ${(p: imageDivProps) => p.fileType === 'svg' ? 'contain' : 'cover'};
...
const CopyrightsGrid = () => {
     ...
     */
    function renderCaption(author: string, license?: string, licenseLink?: string) {
        return (
            <CaptionContainer>
