...
export default function DisclaimerText({ paddingTop, width }) {
    return (
        <div style={{ paddingTop: `${paddingTop}`, width }} className="mx-2">
            ...
            <ul>
                <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Disclaimer) refers to personal site.</li>
                <li><strong>Service</strong> refers to the Website.</li>
                <li><strong>You</strong> means the individual accessing the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                <li><strong>Website</strong> refers to personal site, accessible from <a href="https://jonathanheard.com" rel="external nofollow noopener" target="_blank">https://jonathanheard.com</a></li>
            </ul>
            <h1>Disclaimer</h1>
